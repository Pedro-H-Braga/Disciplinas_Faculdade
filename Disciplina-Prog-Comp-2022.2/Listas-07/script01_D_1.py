...
nome_arquivo = 'media_bandeira.txt'
file_txt = f'{file_path+nome_arquivo}'  

# 'Regiao - Sigla', 'Estado - Sigla', 'Produto', 'Data da Coleta', 'Valor de Venda', 'Bandeira';
lista_valores_D1 = list(criaLista(f'Bandeira','Produto', 'Data da Coleta', 'Valor de Venda'))


valores_txt = [valores+';' for valores in lista_valores_D1]
...
print(f'O tamanho do arquivo é: {len(lista_valores_D1)} linhas')
print(f'Tempo de execução do código SCRIPT_D1: {tempo_exec} segundos')
print(espacamento())