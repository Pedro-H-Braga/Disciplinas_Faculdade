...
def estruturaDB(conexao):
    boolSucesso        = False
    dictEstrutura      = dict()    
    # ARGUMENTOS PARA AS CONSULTAS QUE SERÃO FEITAS NO BANCO
...
# fetchall RETORNA TODAS AS CONSULTAS

# TESTAR ISOLADAMENTE OS RETORNOS DE CADA FUNÇÃO PARA SABER MANIPULAR
